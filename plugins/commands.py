...
main_buttons = [[
        InlineKeyboardButton('📢 Updates', url='https://t.me/moviiieeeesss'),
        InlineKeyboardButton('💬 Support', url='https://t.me/UmbrellaUCorp')
        ],[
        InlineKeyboardButton('🛠️ Help', callback_data='help'),
        InlineKeyboardButton('🩷 About', callback_data='about')
        ],[
        InlineKeyboardButton('get any movies', url='https://t.me/+CQItwmO9k6kwMjRl')
        ]]
...
async def start(client, message):
    ...
    jishubotz = await message.reply_sticker("CAACAgUAAxkBAAIsh2gZHcSAOcXpwoxTUHKTkbb8CLjGAAIEAAPBJDExieUdbguzyBAeBA")
